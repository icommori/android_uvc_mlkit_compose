 ...
 */
class AspectRatioSurfaceView2: SurfaceView, IAspectRatio {
    ...
    private fun setAspectRatio(aspectRatio: Double) {
        ...
        Log.v("innocomm", "setAspectRatio = $mAspectRatio")
        requestLayout()
    }

    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        Log.v("innocomm", "onMeasure = $mAspectRatio")
    ...
    companion object {
        private const val TAG = "innocomm"
    }
}